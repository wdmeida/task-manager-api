...
RSpec.describe 'Tasks API' do
  ...
  let(:headers) do
    {
      ...
      'Accept' => 'application/vnd.taskmananger.v1',
  ...
  describe 'GET /tasks/:id' do
    ...
    context 'when id to task is invalid' do
      let(:id) { 99999 }

      before { get "/tasks/#{id}", params: {}, headers: headers }
  ...
  describe 'PUT /tasks/:id' do
   ...
   describe 'DELETE /tasks/:id' do
     ...
     it 'remvoes the task from the database' do
